...
<body>
    ...
    <section class="hero">
        <div class="container">
            <h1 class="animate__animated animate__fadeInDown">Quick and Affordable Cab Services Just for You!</h1>
            <p class="animate__animated animate__fadeInUp animate-delay-1">Book your ride with us and enjoy a comfortable journey across Colombo.</p>
            <button class="btn btn-custom animate__animated animate__fadeInUp animate-delay-2" onclick="goToHomePage()">Book Now!</button>
        </div>
    </section>
